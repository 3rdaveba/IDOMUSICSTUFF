        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-12">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p
              ...
              style={{ color: 'var(--text-secondary)' }}
            >
              My work is rooted in creating meaningful experiences, supporting creative vision, and guiding projects from concept to completion with intention, care, and professionalism. This site offers a look into my creative process, the work I&apos;ve contributed to, and the projects that reflect my passion for building experiences that connect with people.
            </p>
