...
export const projects: Project[] = [
  {
    ...
    timeline: [
      ...
      { phase: '03', label: 'AI Specialist Integration' },
      { phase: '04', label: 'Safety & Guardrails' },
      { phase: '05', label: 'Ongoing Optimization' },
    ],
    tools: ['Docker', 'Python', 'Multiple AI Model Coordination', 'Shared Memory & Context', 'Automated Scheduling', 'Safety Guardrails'],
    outcomes: [
      'AI assistant runs continuously without supervision',
      'Creative work stays protected from accidental changes',
      'Complete record of every system action',
      'Multiple AI specialists working together as one team',
    ],
  },
  {
