...
export const projects: Project[] = [
  ...
  },
  {
    ...
    dmaic: {
      ...
      M: { label: 'Measure', text: 'Track streaming numbers, saves, completion rates, and listener retention across roughly 30 releases over 12 months to see what the data says about pure consistency.' },
      A: { label: 'Analyze', text: 'Compare which songs and styles perform best, identifying patterns in what resonates with listeners when there is no external promotion driving traffic.' },
      I: { label: 'Improve', text: 'If certain tracks gain traction or generate purchase interest, explore reproduction or licensing opportunities. Reinvest any revenue back into refining the workflow.' },
    ...
    tools: ['Suno', 'AI Music Tools', 'DSP Streaming', 'Metadata Systems'],
    outcomes: [
      'Roughly 30 releases deployed over 12 months',
      'Organic streaming revenue generated without marketing spend',
      'Clear picture of what resonates through consistency alone',
      'Revenue and licensing opportunities surfaced by data',
