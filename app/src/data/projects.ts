...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Directed the LMU Gospel Choir, a non-audition ensemble housed in the Department of African American Studies and offered across four course levels (AFAM-2261 through AFAM-2264). Assumed the role upon recommendation from the previous director and led semester-long cycles of recruitment, rehearsal, and performance. Managed all aspects of production including one-on-one vocal coaching, graphic design for promotional materials, hiring session musicians, negotiating departmental budgets, and collaborating with alumni vocalists for end-of-semester concerts.',
    dmaic: {
