...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Director of the LMU Gospel Choir for 7 years, building community among diverse students while educating them in African American Gospel Music performance, history, and cultural context. Led the choir through a dynamic pandemic-era performance experience featuring professional audio production, video post-production, and remote collaboration.',
    dmaic: {
      D: { label: 'Define', text: 'Build and sustain the LMU Gospel Choir as an inclusive musical community, educating students in African American Gospel Music while delivering high-quality performances on and off campus.' },
      M: { label: 'Measure', text: 'Student vocal development, performance quality, recruitment growth, community engagement, and successful execution of performances including a pandemic-era video production.' },
      A: { label: 'Analyze', text: 'Balancing academic instruction with performance preparation across diverse skill levels. Navigating pandemic-era constraints requiring remote collaboration, video production, and maintaining choir cohesion without in-person rehearsals.' },
      I: { label: 'Improve', text: 'Developed curriculum combining historical context with practical vocal training. Selected repertoire for performances. Scheduled rehearsals and coordinated performances. Produced a professional pandemic-era performance video with full audio mix/master and video post-production.' },
      C: { label: 'Control', text: 'Choir sustained for 7+ years with ongoing student development. Pandemic performance video delivered with professional audio and visual polish. Active recruitment and community building within the Music Department.' },
    },
    timeline: [
      { phase: '01', label: 'Curriculum Development' },
      { phase: '02', label: 'Recruitment & Outreach' },
      { phase: '03', label: 'Rehearsal & Vocal Training' },
      { phase: '04', label: 'Performance Production' },
      { phase: '05', label: 'Community Building' },
    ],
    tools: ['Vocal Direction', 'Curriculum Design', 'Music Selection', 'Audio Mixing & Mastering', 'Video Post-Production', 'Recruitment', 'Community Engagement'],
    outcomes: [
      '7+ years of sustained choir direction and student development',
      'Professional pandemic-era performance video produced',
      'Diverse student population educated in African American Gospel Music',
      'On-campus and off-campus performances delivered',
      'Active recruitment supporting Music Department growth',
    ],
    media: {
      items: [
        { type: 'photo-slot', label: 'Photo' },
