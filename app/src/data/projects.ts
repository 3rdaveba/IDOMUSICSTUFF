...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Directed the LMU Gospel Choir through semester-long cycles of recruitment, rehearsal, and performance. Managed all aspects of production including graphic design for promotional materials, hiring session musicians, negotiating departmental budgets, and collaborating with alumni vocalists for end-of-semester concerts.',
    dmaic: {
      D: { label: 'Define', text: 'Build a semester-based gospel choir program focused on student vocal development, culturally informed performance, and end-of-semester concerts that engage the campus and broader community.' },
      M: { label: 'Measure', text: 'Student enrollment and retention, performance quality, vocal growth across the semester, successful execution of end-of-semester concerts, and community engagement.' },
      A: { label: 'Analyze', text: 'Balancing academic instruction with performance preparation across varying skill levels. Managing limited departmental budgets, hiring external musicians, coordinating alumni participation, and creating promotional materials to drive attendance.' },
      I: { label: 'Improve', text: 'Designed semester curricula combining African American Gospel Music history with practical vocal training. Created flyers and promotional graphics for performances. Hired session musicians. Negotiated budget allocation with department leadership. Invited alumni to return as lead vocalists for concerts. Submitted proposals for community engagement events.' },
      C: { label: 'Control', text: 'Multiple semesters of successful end-of-semester concerts delivered. Students developed vocal technique and cultural understanding. Alumni collaborations strengthened the program\'s legacy. Promotional materials consistently drove audience attendance.' },
    },
    timeline: [
      { phase: '01', label: 'Semester Planning & Budget' },
      { phase: '02', label: 'Recruitment & Auditions' },
      { phase: '03', label: 'Rehearsal & Curriculum' },
      { phase: '04', label: 'Performance Production' },
      { phase: '05', label: 'Concert & Evaluation' },
    ],
    tools: ['Vocal Direction', 'Curriculum Design', 'Graphic Design', 'Budget Negotiation', 'Talent Acquisition', 'Alumni Relations', 'Event Planning', 'Music Selection'],
    outcomes: [
