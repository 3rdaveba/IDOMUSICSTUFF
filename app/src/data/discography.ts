...
export const discography: DiscographyEntry[] = [
  ...
  },
  {
    ...
    role: 'Performer',
    type: 'single',
    image: 'images/discography/sinners-this-little-light-of-mine.jpg',
    links: {},
    stats: {
      spotifyStreams: 3.0,
      youtubeViews: 426.9,
...
export const streamingStats = {
  totalSpotifyStreams: 442.8,    // millions
  totalYoutubeViews: 51176.4,    // thousands = ~51.2M
  totalAirplaySpins: 38038,
